...
return view('qc-sistem.pemeriksaan-kedatangan-chemical.index', compact('pemeriksaans', 'produkKategoriOptions', 'produkList', 'produkByKategori'));
    ...
    public function show(PemeriksaanKedatanganChemical $pemeriksaanChemical)
    {
        ...
        return view('qc-sistem.pemeriksaan-kedatangan-chemical.show', compact('pemeriksaanChemical', 'produkMeta', 'produkByChemicalId', 'produkNamaById'));
    }
    ...
    public function exportPDF(Request $request)
    {
        ...
        if ($uuid) {
            $pemeriksaan = PemeriksaanKedatanganChemical::where('uuid', $uuid)
                ->with([
                    'user.role',
                    'user.plant',
                    'shift',
            ...
            return $pdf->download('chemical-' . $pemeriksaan->uuid . '.pdf');
        }
    ...
    public function batchVerify(Request $request)
    {
        ...
        $query = PemeriksaanKedatanganChemical::query();
