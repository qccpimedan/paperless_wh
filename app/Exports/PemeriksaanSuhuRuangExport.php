...
class PemeriksaanSuhuRuangExport implements FromView, WithTitle, ShouldAutoSize, WithColumnWidths
{
    ...
    {
        return view('qc-sistem.pemeriksaan-suhu-ruang.excel-export', [
