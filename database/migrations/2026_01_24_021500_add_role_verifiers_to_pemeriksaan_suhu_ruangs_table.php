...
return new class extends Migration
{
    ...
    {
        $hasQc = Schema::hasColumn('pemeriksaan_suhu_ruangs', 'verified_by_qc');
        $hasProduksi = Schema::hasColumn('pemeriksaan_suhu_ruangs', 'verified_by_produksi');
        $hasSpv = Schema::hasColumn('pemeriksaan_suhu_ruangs', 'verified_by_spv');

        if (!$hasQc || !$hasProduksi || !$hasSpv) {
            Schema::table('pemeriksaan_suhu_ruangs', function (Blueprint $table) use ($hasQc, $hasProduksi, $hasSpv) {
                if (!$hasQc) {
