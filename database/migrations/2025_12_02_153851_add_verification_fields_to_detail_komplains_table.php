...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('detail_komplains', function (Blueprint $table) {
            // Status verifikasi: pending, sent_to_qc, approved_qc, rejected_qc, approved_spv, rejected_spv
            $table->enum('status_verifikasi', ['pending', 'sent_to_qc', 'approved_qc', 'rejected_qc', 'approved_spv', 'rejected_spv'])
                  ->default('pending')
                  ->after('upload_suplier');
