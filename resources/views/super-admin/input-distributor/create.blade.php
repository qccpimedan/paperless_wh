        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Tambah distributor baru</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Input Distributor</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Form Input Distributor</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form class="form form-horizontal" action="{{ route('distributors.store') }}" method="POST">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div id="dynamic-fields">
                                                    <div class="input-group mb-2">
                                                        <input type="text" class="form-control @error('nama_distributor.0') is-invalid @enderror"
                                                            name="nama_distributor[]" placeholder="Nama Distributor" value="{{ old('nama_distributor.0') }}" required>
    ...
    document.getElementById('dynamic-fields').addEventListener('click', function(e) {
        if (e.target.closest('.remove-field')) {
            ...
            if (fieldCount > 1) {
                ...
                alert('Minimal harus ada satu field nama distributor!');
            }
        }
    });
});
