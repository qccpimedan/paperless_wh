        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Input Produk</h3>
                    <p class="text-subtitle text-muted">Tambah produk baru untuk sistem</p>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form class="form form-horizontal" action="{{ route('produks.store') }}" method="POST">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div id="dynamic-fields">
                                                    <div class="input-group mb-2">
                                                        <input type="text" class="form-control @error('nama_produk.0') is-invalid @enderror"
                                                            name="nama_produk[]" placeholder="Nama Produk" value="{{ old('nama_produk.0') }}" required>
    ...
    document.getElementById('dynamic-fields').addEventListener('click', function(e) {
        if (e.target.closest('.remove-field')) {
            ...
            if (fieldCount > 1) {
                ...
                alert('Minimal harus ada satu field nama produk!');
            }
        }
    });
});
