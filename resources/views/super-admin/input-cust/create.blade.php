        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Tambah customer baru untuk sistem</p>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <form class="form form-horizontal" action="{{ route('customers.store') }}" method="POST">
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="nama_cust">Nama Customer <span class="text-danger">*</span></label>
                                                <div id="dynamic-fields">
                                                    <div class="input-group mb-2">
                                                        <input type="text" class="form-control @error('nama_cust.0') is-invalid @enderror"
                                                            name="nama_cust[]" placeholder="Nama Customer" value="{{ old('nama_cust.0') }}" required>
                                            ...
                                            <div class="col-md-12 d-flex justify-content-end mt-3">
                                                ...
                                                <a href="{{ route('customers.index') }}" class="btn btn-light-secondary me-1 mb-1">Kembali</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('add-field').addEventListener('click', function() {
        ...
        newField.innerHTML = `
            <input type="text" class="form-control" name="nama_cust[]" placeholder="Nama Customer" required>
    ...
    document.getElementById('dynamic-fields').addEventListener('click', function(e) {
        if (e.target.closest('.remove-field')) {
            ...
            if (fieldCount > 1) {
                ...
                alert('Minimal harus ada satu field nama customer!');
            }
        }
    });
});
