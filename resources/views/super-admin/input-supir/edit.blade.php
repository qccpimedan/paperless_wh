        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Edit Supir</h3>
                    <p class="text-subtitle text-muted">Edit supir yang sudah ada</p>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form class="form form-horizontal" action="{{ route('supirs.update', $supir->uuid) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="nama_supir" class="form-control @error('nama_supir') is-invalid @enderror"
                                                    name="nama_supir" placeholder="Nama Supir" 
                                                    value="{{ old('nama_supir', $supir->nama_supir) }}" required>
                                                @error('nama_supir')
