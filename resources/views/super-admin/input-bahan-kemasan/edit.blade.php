        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Edit Bahan Kemasan</h3>
                    <p class="text-subtitle text-muted">Edit bahan kemasan yang sudah ada</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Bahan Kemasan</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Form Edit Bahan Kemasan</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form class="form form-horizontal" action="{{ route('bahan-kemasans.update', $bahanKemasan->uuid) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-body">
                                        <div class="row">
