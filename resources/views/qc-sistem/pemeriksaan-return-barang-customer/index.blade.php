                    ...
                    <div class="row mb-4 p-3 bg-light rounded">
                        ...
                        <form action="{{ route('return-barang.export-pdf') }}" method="GET" class="row g-3" id="filterForm">
                            ...
                            <div class="col-md-3 d-flex align-items-end gap-2">
                                ...
                                @if($canVerify)
                                    <button type="submit" class="btn btn-primary flex-grow-1" formaction="{{ route('return-barang.batch-verify') }}" formmethod="POST" onclick="return confirm('Verifikasi semua data pada filter ini?')">
