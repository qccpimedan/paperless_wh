                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select id="id_produk" class="choices form-select @error('id_produk') is-invalid @enderror"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" id="suhu_produk" class="form-control @error('suhu_produk') is-invalid @enderror"
                                                    name="suhu_produk" placeholder="Contoh: -18°C" value="{{ old('suhu_produk') }}">
                                                @error('suhu_produk')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" id="kode_produksi" class="form-control @error('kode_produksi') is-invalid @enderror"
                                                    name="kode_produksi" value="{{ old('kode_produksi') }}" required>
                                                @error('kode_produksi')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" id="jumlah_barang" class="form-control @error('jumlah_barang') is-invalid @enderror"
                                                    name="jumlah_barang" placeholder="Contoh: 10 Karung" value="{{ old('jumlah_barang') }}" required>
                                                @error('jumlah_barang')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="kondisi_kemasan" id="kemasan_ya" value="1" {{ old('kondisi_kemasan') == '1' ? 'checked' : '' }} required>
                                                    <label class="form-check-label" for="kemasan_ya">Ya ✓</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="kondisi_kemasan" id="kemasan_tidak" value="0" {{ old('kondisi_kemasan') == '0' ? 'checked' : '' }} required>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="kondisi_produk_check" id="produk_ya" value="1" {{ old('kondisi_produk_check') == '1' ? 'checked' : '' }} required>
                                                    <label class="form-check-label" for="produk_ya">Ya ✓</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="kondisi_produk_check" id="produk_tidak" value="0" {{ old('kondisi_produk_check') == '0' ? 'checked' : '' }} required>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="rekomendasi" class="form-control @error('rekomendasi') is-invalid @enderror"
                                                    name="rekomendasi" value="{{ old('rekomendasi') }}" required>
                                                @error('rekomendasi')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
