                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('pemeriksaan-chemical.index') }}" method="GET" class="row g-3 mb-3">
                        ...
                        <div class="col-md-3 d-flex align-items-end gap-2">
                            ...
                            <a href="{{ route('pemeriksaan-chemical.index') }}" class="btn btn-secondary btn-sm">Reset</a>
                        </div>
                    </form>
                                    ...
                                    @forelse($pemeriksaans as $index => $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    $details = $item->detail_chemicals ?? [];
                                                    $kodeProduksis = array_values(array_filter(array_column($details, 'kode_produksi')));
                                                @endphp
                                                @if(count($kodeProduksis) > 0)
                                                    {{ $kodeProduksis[0] }}
                                                    @if(count($kodeProduksis) > 1) 
                                                        <br><small class="text-muted">+{{ count($kodeProduksis)-1 }} lainnya</small> 
                                                    @endif
                                                @else - @endif
                                            </td>
                                            <td>
            ...
            <div class="modal fade" id="multiApprovalModal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('pemeriksaan-chemical.batch-verify') }}" method="POST">
                            @csrf
