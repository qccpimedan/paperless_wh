                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="segel_gembok" name="segel_gembok" value="1" {{ old('segel_gembok') ? 'checked' : '' }}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="id_chemical" class="choices form-control @error('id_chemical') is-invalid @enderror" name="id_chemical">
                                                    ...
                                                    @foreach ($chemicals as $chemical)
                                                        <option value="{{ $chemical->id }}" {{ old('id_chemical') == $chemical->id ? 'selected' : '' }}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="id_produsen" class="choices form-control @error('id_produsen') is-invalid @enderror" name="id_produsen">
                                                    ...
                                                    @foreach ($produsens as $produsen)
                                                        <option value="{{ $produsen->id }}" {{ old('id_produsen') == $produsen->id ? 'selected' : '' }}>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="persyaratan_dokumen_halal" id="persyaratan_dokumen_halal_ya" value="1" {{ old('persyaratan_dokumen_halal') == '1' ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="persyaratan_dokumen_halal_ya">Ya ✓</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="persyaratan_dokumen_halal" id="persyaratan_dokumen_halal_tidak" value="0" {{ old('persyaratan_dokumen_halal') == '0' ? 'checked' : '' }}>
