        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Edit Pemeriksaan Barang Mudah Pecah</h3>
                    <p class="text-subtitle text-muted">Edit Pemeriksaan</p>
                </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Form Edit Pemeriksaan Barang Mudah Pecah</h4>
                        </div>
                                ...
                                <form action="{{ route('pemeriksaan-barang-mudah-pecah.update', $pemeriksaanBarangMudahPecah->uuid) }}" method="POST">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select @error('id_shift') is-invalid @enderror" name="id_shift" id="id_shift" required>
                                                ...
                                                @foreach($shifts as $shift)
                                                    <option value="{{ $shift->id }}" {{ $pemeriksaanBarangMudahPecah->id_shift == $shift->id ? 'selected' : '' }}>
                                                        {{ $shift->shift }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control @error('tanggal') is-invalid @enderror" name="tanggal" id="tanggal" value="{{ $pemeriksaanBarangMudahPecah->tanggal }}" required>
                                            @error('tanggal')
                                                <div class="text-danger small">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select @error('id_area') is-invalid @enderror" name="id_area" id="id_area" required>
                                                ...
                                                @foreach($areas as $area)
                                                    <option value="{{ $area->id }}" {{ $pemeriksaanBarangMudahPecah->id_area == $area->id ? 'selected' : '' }}>
                                                        {{ $area->nama_area }}
                                                    </option>
                                                @endforeach
                                            </select>
