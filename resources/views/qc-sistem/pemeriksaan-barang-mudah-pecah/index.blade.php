        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Pemeriksaan Barang Mudah Pecah (Glass & Fragile)</h3>
                    <p class="text-subtitle text-muted">Kelola data pemeriksaan barang mudah pecah di area produksi</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Barang Mudah Pecah</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">Daftar Pemeriksaan Barang Mudah Pecah</h5>
                ...
                <div class="card-body">
                    <div class="row mb-4 p-3 bg-light rounded">
                        ...
                        <form action="{{ route('pemeriksaan-barang-mudah-pecah.export-pdf') }}" method="GET" class="row g-3" id="filterForm">
                            <div class="col-md-3">
                    ...
                    <form action="{{ route('pemeriksaan-barang-mudah-pecah.index') }}" method="GET" class="row g-3 mb-3">
                        ...
                        <div class="col-md-3 d-flex align-items-end gap-2">
                            ...
                            <a href="{{ route('pemeriksaan-barang-mudah-pecah.index') }}" class="btn btn-secondary btn-sm">Reset</a>
                        </div>
                    </form>

                    <form id="batchActionForm" action="{{ route('pemeriksaan-barang-mudah-pecah.batch-verify') }}" method="POST">
                        @csrf
                                ...
                                <tbody>
                                    @forelse($pemeriksaans as $index => $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    @can('view_pemeriksaan_barang_mudah_pecah') <a href="{{ route('pemeriksaan-barang-mudah-pecah.show', $item->uuid) }}" class="btn btn-sm btn-info text-white"><i class="bi bi-eye"></i></a> @endcan
                                                    @can('edit_pemeriksaan_barang_mudah_pecah') <a href="{{ route('pemeriksaan-barang-mudah-pecah.edit', $item->uuid) }}" class="btn btn-sm btn-warning text-white"><i class="bi bi-pencil"></i></a> @endcan
                                                </div>
                                            </td>
                                        </tr>
                                    @empty
            ...
            <div class="modal fade" id="multiApprovalModal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('pemeriksaan-barang-mudah-pecah.batch-verify') }}" method="POST">
                            @csrf
