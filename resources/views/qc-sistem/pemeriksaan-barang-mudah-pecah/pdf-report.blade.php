        ...
        <div class="header-left">
            <div class="logo-company">
                ...
                <div class="header-company">
                    ...
                    <p>FOOD DIVISION {{ strtoupper(auth()->user()->plant->plant ?? 'MEDAN') }}</p>
                    <p>{{ strtoupper(auth()->user()->plant->plant ?? 'MEDAN') }} - INDONESIA</p>
                </div>
            </div>
        </div>
            ...
            <tr>
                <td class="signature-cell">
                    ...
                    <div class="signature-space">
                        @if($qcName)
                            @php
                                $qcQrData = "Dokumen ini telah diverifikasi secara sistem oleh {$qcName} (Tim QC)";
                ...
                <td class="signature-cell">
                    ...
                    <div class="signature-space">
                        @if($produksiName)
                            @php
                                $prodQrData = "Dokumen ini telah diverifikasi secara sistem oleh {$produksiName} (Tim Warehouse)";
                ...
                <td class="signature-cell">
                    ...
                    <div class="signature-space">
                        @if($spvName)
                            @php
                                $spvQrData = "Dokumen ini telah diverifikasi secara sistem oleh {$spvName} (Tim Supervisor QC)";
