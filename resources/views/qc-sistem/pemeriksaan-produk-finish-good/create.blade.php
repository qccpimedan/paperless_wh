...
<script>
document.addEventListener('DOMContentLoaded', function() {
    const form = document.getElementById('form-pemeriksaan-produk-finish-good');
    ...
    function validateForm() {
        ...
        // 2. Status Baris - Minimal satu item harus memilih "Hold" atau "Release"
        const statusBarisSelects = document.querySelectorAll('select[name="status_baris[]"]');
