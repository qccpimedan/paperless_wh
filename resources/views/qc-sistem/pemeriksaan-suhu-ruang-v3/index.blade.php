        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Data Gudang Dry</h3>
                    <p class="text-subtitle text-muted">Kelola data Gudang Dry</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Data Gudang Dry</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">Daftar Gudang Dry</h5>
                ...
                <div class="card-body">
                    <!-- <div class="row mb-4 p-3 bg-light rounded">
                        ...
                        <form action="{{ route('pemeriksaan-suhu-ruang-v3.export-pdf') }}" method="GET" class="row g-3" id="pdfFilterForm">
                            <div class="col-md-3">
                    ...
                    <form action="{{ route('pemeriksaan-suhu-ruang-v3.index') }}" method="GET" class="row g-3 mb-3">
                        <div class="col-md-9">
                            <input type="text" name="search" class="form-control" placeholder="Cari tanggal/pukul/status/shift/area..." value="{{ request('search') }}">
                        </div>
                        <div class="col-md-3 d-flex align-items-end">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-vertical">
                                                ...
                                                @endcan
                                                <a href="{{ route('pemeriksaan-suhu-ruang-v3.print-pdf', $pemeriksaan->uuid) }}" 
