            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mb-4 p-3 bg-light rounded">
                        ...
                        <form action="{{ route('pemeriksaan-kedatangan-kemasan.export-pdf') }}" method="GET" class="row g-3" id="filterForm">
                            ...
                            <div class="col-md-3 d-flex align-items-end gap-2">
                                ...
                                @if($canVerify)
                                    <button type="submit" class="btn btn-primary flex-grow-1" formaction="{{ route('pemeriksaan-kedatangan-kemasan.batch-verify') }}" formmethod="POST" onclick="return confirm('Verifikasi massal semua data pada filter ini?')">
                    ...
                    <form action="{{ route('pemeriksaan-kedatangan-kemasan.index') }}" method="GET" class="row g-3 mb-3">
                        <div class="col-md-9"><input type="text" name="search" class="form-control" placeholder="Cari data..." value="{{ request('search') }}"></div>
                        <div class="col-md-3 d-flex align-items-end"><button type="submit" class="btn btn-primary w-100">Cari</button></div>
                    </form>
