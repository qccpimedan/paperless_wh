        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>CS Meat</h3>
                    <p class="text-subtitle text-muted">Buat CS Meat baru</p>
                </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Form Buat CS Meat</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form id="form-pemeriksaan-suhu-ruang-v2" data-autosave="true" class="form form-horizontal" action="{{ route('pemeriksaan-suhu-ruang-v2.store') }}" method="POST">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-12 d-flex justify-content-end mt-4">
                                                ...
                                                <a href="{{ route('pemeriksaan-suhu-ruang-v2.index') }}" class="btn btn-light-secondary me-1 mb-1 btn-kembali-confirm">
                                                    Kembali
                                                </a>
                                            </div>
                                        </div>
