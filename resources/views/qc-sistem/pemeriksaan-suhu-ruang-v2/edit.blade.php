                                                    ...
                                                    <td class="text-center">
                                                        @if($tRow['tipe'] === 'update' && !empty($tRow['history_uuid']))
                                                            <div class="d-flex justify-content-center gap-1">
                                                                ...
                                                                <form action="{{ route('pemeriksaan-suhu-ruang-v2.history.destroy', [$pemeriksaanSuhuRuangV2->uuid, $tRow['history_uuid']]) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus area ini dari riwayat per jam?');" style="display:inline;">
                                                                    @csrf
                                                                    @method('DELETE')
