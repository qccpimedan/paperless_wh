                    ...
                    <div class="alert alert-light border-start border-4">
                        ...
                        <div class="mb-3 pb-3 border-bottom">
                            <strong class="text-warning d-block mb-2">
                                <i class="bi bi-person-badge-fill me-2"></i>Produksi
                            </strong>
                        ...
                        <div>
                            ...
                            <p class="mb-0 ms-4 text-muted">Bertugas untuk melakukan verifikasi lanjutan dari form yang telah diisi oleh QC dan disetujui oleh produksi</p>
                        </div>
                    </div>
                </div>
            </div>
